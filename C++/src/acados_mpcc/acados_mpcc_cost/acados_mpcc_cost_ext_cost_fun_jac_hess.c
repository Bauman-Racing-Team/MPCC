...
/* acados_mpcc_cost_ext_cost_fun_jac_hess:(i0[11],i1[4],i2[],i3[5])->(o0,o1[15],o2[15x15,14nz]) */
...
CASADI_SYMBOL_EXPORT int acados_mpcc_cost_ext_cost_fun_jac_hess_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
