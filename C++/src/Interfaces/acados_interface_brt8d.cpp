#include "acados_interface_brt8d.hpp"

#include "brt8d/acados_solver_acados_mpcc.h"
...
void AcadosInterfaceBrt8D::setInitialValues(std::vector<OptVariables> &initialGuess)
{
...
void AcadosInterfaceBrt8D::setParameters(AcadosParameters parameters)
{
  acados_mpcc_solver_capsule *castedAcadosOcpCapsule =
    static_cast<acados_mpcc_solver_capsule *>(d_acadosOcpCapsule);
...
solverReturn AcadosInterfaceBrt8D::solve()
{
  int rtiPhase = 0;
  solverReturn mpcSol;
...
void AcadosInterfaceBrt8D::generateSolution()
{
  ocp_nlp_config *castedNlpConfig = static_cast<ocp_nlp_config *>(d_nlpConfig);
  ocp_nlp_dims *castedNlpDims = static_cast<ocp_nlp_dims *>(d_nlpDims);
  ocp_nlp_out *castedNlpOut = static_cast<ocp_nlp_out *>(d_nlpOut);
...
void AcadosInterfaceBrt8D::freeSolver()
{
  acados_mpcc_solver_capsule *castedAcadosOcpCapsule =
    static_cast<acados_mpcc_solver_capsule *>(d_acadosOcpCapsule);
