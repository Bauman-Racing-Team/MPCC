#include "acados_interface_brt9d.hpp"

#include "brt9d/acados_solver_acados_mpcc.h"
...
void AcadosInterfaceBrt9D::setInitialValues(std::vector<OptVariables> &initialGuess)
{
...
void AcadosInterfaceBrt9D::setParameters(AcadosParameters parameters)
{
  acados_mpcc_solver_capsule *castedAcadosOcpCapsule =
    static_cast<acados_mpcc_solver_capsule *>(d_acadosOcpCapsule);
...
solverReturn AcadosInterfaceBrt9D::solve()
{
  int rtiPhase = 0;
  solverReturn mpcSol;
...
void AcadosInterfaceBrt9D::generateSolution()
{
  ocp_nlp_config *castedNlpConfig = static_cast<ocp_nlp_config *>(d_nlpConfig);
  ocp_nlp_dims *castedNlpDims = static_cast<ocp_nlp_dims *>(d_nlpDims);
  ocp_nlp_out *castedNlpOut = static_cast<ocp_nlp_out *>(d_nlpOut);
...
void AcadosInterfaceBrt9D::freeSolver()
{
  acados_mpcc_solver_capsule *castedAcadosOcpCapsule =
    static_cast<acados_mpcc_solver_capsule *>(d_acadosOcpCapsule);
